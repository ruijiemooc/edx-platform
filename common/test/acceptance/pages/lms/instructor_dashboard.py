...
class CertificatesPage(PageObject):
    ...
    def add_certificate_invalidation(self, student, notes):
        ...
        self.wait_for_ajax()
        self.wait_for(
            lambda: student in self.get_selector('div.certificate-invalidation-history table tr:last-child td').text,
    ...
    def remove_first_certificate_invalidation(self):
        ...
        """
        self.wait_for_element_visibility('#invalidate-certificate', 'Invalidate Certificate button is visible')
        self.get_selector('div.certificate-invalidation-history table tr td .re-validate-certificate').first.click()
        self.wait_for_ajax()
