...
class TestProgramRetrieval(ProgramsApiConfigMixin, ProgramsDataMixin, CredentialsApiConfigMixin, TestCase):
    ...
    def test_get_programs_caching(self):
        ...
        self.create_program_config(cache_ttl=1)
        self.mock_programs_api()
    ...
    def test_get_program_for_certificates(self):
        ...
        actual = get_programs_for_credentials(self.user, self.PROGRAMS_CREDENTIALS_DATA, credentials_config)
    ...
    def test_get_program_for_certificates_id_not_exist(self):
        ...
        actual = get_programs_for_credentials(self.user, credential_data, credentials_config)
        self.assertEqual(actual, [])
